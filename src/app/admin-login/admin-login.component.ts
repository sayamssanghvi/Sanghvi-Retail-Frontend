...
export class AdminLoginComponent implements OnInit {
  ...
  constructor(formBuilder: FormBuilder, private adminService: AdminService, private router: Router, private renderer: Renderer2, private snackBar: MatSnackBar) {
  ...
  SubmitForm(form: FormGroup) {
    ...
    this.renderer.setProperty(this.submitButton.nativeElement, 'innerHTML', this.actions.SIGNING_YOU_IN);
    this.adminService.setAdmin(this.getPayLoad()).subscribe((response) => {
      if (response.valid)
